...
{   
    ...
    public function postLogin(Request $request){
        ...
        $messages = [
           ...
           'email.email' => 'El formato de su correo electrónicoes invalido',
    ...
    public function postRegister(Request $request){
        ...
        if($validator->fails()):
            ...
            if($user->save()):
                return redirect('/login')->with('message', 'Su usuario se creó con éxito, ahora puedes iniciar sesión ')->with('typealert', 'success');
            endif;
        endif;
    }
