        ...
        <div class="col-md-6 login-form-1">
            ...
            <form>
                <div class="row">
                 ...
                 <div class="col">
                  <label for="inputPassword5">Foto del DUI:</label>
                  <input type="text" class="form-control" placeholder="foto"value="">
                 </div>
                 <br><hr>
            ...
            <form>
                <div class="form-row">
                 ...
                 <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      <label for="inputCity">foto tamaño cedula:</label>
                      <input type="text" class="form-control" id="inputCity" placeholder="Foto del alumno"value="">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputState">Foto partida:</label>
                      <input type="text" class="form-control" id="inputCity" placeholder="Partidade nacimiento"value="">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputState">Foto certificado:</label>
                      <input type="text" class="form-control" id="inputCity" placeholder="Certificado"value="">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <label for="inputCity">Foto de notas:</label>
                      <input type="text" class="form-control" id="inputCity" placeholder="Constancia/de/notas"value="">
                    </div>
                    <div class="col">
                      <label for="inputState">foto/constancia/conducta:</label>
                      <input type="text" class="form-control" id="inputCity" placeholder="Constancia de conducta"value="">
                    </div>
                  </div>
                  <hr>
                <div class="form-group">
