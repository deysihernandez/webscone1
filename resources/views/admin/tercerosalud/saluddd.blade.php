...
<ul class="nav nav-tabs bg-light">
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/primerosalud/') }}" >1º Atencion Primaria en salud (A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/segundosalud/') }}" >2º Atencion Primaria en salud (A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/tercerosalud/') }}" >3º Atencion Primaria en salud (A)</a>
  </li>
</ul>
<div class="card text-center">
    <div class="card-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand">Listado de estudiantes de 3º Atencion primaria en salud</a>
