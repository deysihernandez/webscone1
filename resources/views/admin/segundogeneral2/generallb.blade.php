...
<div class="card text-center">
    <div class="card-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand">Listado de estudiantes de 2º General (B)</a>
            ...
            <thead bg-info>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="{{ url('/admin/inforacion/') }}"><button type="button" class="btn btn-info">Informacion</button></a></td>
