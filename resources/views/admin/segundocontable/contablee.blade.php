...
<ul class="nav nav-tabs bg-light">
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/primerocontable/') }}" >1º Administrativo contable seccion(A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="{{ url('/admin/segundocontable/') }}">2º Administrativo  contable seccion(A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="{{ url('/admin/tercerocontable/') }}">3º Administrativo  contable seccion(A)</a>
  </li>
</ul>
<div class="card text-center">
    <div class="card-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand">Listado de estudiantes de 2º Administrativo contable</a>
