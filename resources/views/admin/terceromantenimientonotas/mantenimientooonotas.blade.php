...
@section('title', 'Notas mantenimiento')
...
<div class="card text-center">
    <div class="card-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand">Listado de estudiantes de 3º Mantenimiento Automtriz (A)</a>
            ...
            <thead bg-info>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td><a href="{{ url('/admin/agregarotas/') }}"><button type="button" class="btn btn-success">Agregar Notas</button></a></td>
                  <td><a href="{{ url('/admin/informacion/') }}"><button type="button" class="btn btn-info">Mas Informacion</button></a></td>
                </tr>
                </tr>
              </tbody>
