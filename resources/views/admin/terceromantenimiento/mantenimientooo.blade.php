...
<ul class="nav nav-tabs bg-light">
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/primeromantenimiento/') }}" >1º Mantenimiento Automotriz (A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/segundomantenimiento/') }}" >2º Mantenimiento Automotriz (A)</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active"href="{{ url('/admin/terceromantenimiento/') }}" >3º Mantenimiento Automotriz (A)</a>
  </li>
</ul>
<div class="card text-center">
    <div class="card-header">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand">Listado de estudiantes de 3º Mantenimiento Automtriz</a>
